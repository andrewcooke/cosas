...
int16_t Merge::next(int64_t tick, int32_t phi) {
...
int16_t Mixer::next(int64_t tick, int32_t phi) {
...
int16_t FM::next(int64_t tick, int32_t phi) {
...
int16_t MixedFM::next(int64_t tick, int32_t phi) {
...
int16_t AM::next(int64_t tick, int32_t phi) {
...
int16_t MixedAM::next(int64_t tick, int32_t phi) {
  return mixer.next(tick, phi);
}
